...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="/main/adminMain">TripWeaver 관리자</a></div>

        <div id="tnb">
            <ul>
                <li class="tnb_li"><a href="/main/main" class="tnb_community" target="_blank" title="커뮤니티 바로가기">커뮤니티 바로가기</a></li>
