...
<div class="mypage_left">
	...
	<ul class="mypage_leftUl2">
		...
		<li class="mypage_leftHover"><a href="">나의 여행일정 관리</a></li>
		<li class="mypage_leftHover"><a href="">나의 투어관리</a></li>
		<%-- 나의 예약관리는 가이드 레벨에서만 보임 if 조건 ㄱㄱ --%>
		<li class="mypage_leftHover"><a href="">나의 예약</a></li>
		<%-- --%>
		<li class="mypage_leftHover"><a href="">게시글 관리</a></li>
