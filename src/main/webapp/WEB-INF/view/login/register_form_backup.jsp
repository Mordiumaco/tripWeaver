...
<div id="container">
	...
	<form id="fregisterform" name="fregisterform" action="https://demo.sir.kr/gnuboard5/bbs/register_form_update.php" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
		<input type="hidden" name="w" value=""> 
		<input type="hidden" name="url" value="%2Fgnuboard5%2Fbbs%2Fregister_form.php"> 
			...
			<div>
				...
				<ul>
					<li>
						...
						<input type="text" name="mb_id" value="" id="reg_mb_id"	required="" class="frm_input half_input required " minlength="3" maxlength="20" placeholder="아이디"> <span id="msg_mb_id"></span>
						<span class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</span>
					</li>
					<br/>
					<li>
						<label for="reg_mb_password" class="sound_only">비밀번호<strong class="sound_only">필수</strong></label> 
						<input type="password" name="mb_password" id="reg_mb_password" required="" class="frm_input half_input required" minlength="3" maxlength="20" placeholder="비밀번호"> 
						<label for="reg_mb_password_re" class="sound_only">비밀번호 확인<strong>필수</strong></label> 
						<input type="password" name="mb_password_re" id="reg_mb_password_re" required="" class="frm_input half_input right_input required" minlength="3" maxlength="20" placeholder="비밀번호 확인">
					</li>
					<br/>
				</ul>
			</div>
			<div class="tbl_frm01 tbl_wrap">
				...
				<ul>
					<li>
						...
						<input type="text" id="reg_mb_name" name="mb_name" value=""	required="" class="frm_input half_input required " size="10" placeholder="이름">
					</li>
					<br/>
					<li>
						<label for="reg_mb_nick" class="sound_only">닉네임<strong>필수</strong></label>
						<input type="hidden" name="mb_nick_default" value=""> 
						<input type="text" name="mb_nick" value="" id="reg_mb_nick" required="" class="frm_input required nospace  half_input" size="10" maxlength="20" placeholder="닉네임"> 
					...
					<li>
						...
						<input type="text" name="mb_zip" value="" id="reg_mb_zip" required="" class="frm_input required" size="5" maxlength="6" placeholder="우편번호">
						<button type="button" class="btn_frmline" onclick="win_zip('fregisterform', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');">주소검색</button>
						<br> 
						<input type="text" name="mb_addr1" value="" id="reg_mb_addr1" required="" class="frm_input frm_address full_input required" size="50" placeholder="기본주소"> 
			...
			<div class="tbl_frm01 tbl_wrap">
				...
				<ul>
					<li>
						...
						<input type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" checked=""> 정보 메일을 받겠습니다.
					</li>
					<li>
						<label for="reg_mb_open" class="frm_label">정보공개</label> 
						<input type="hidden" name="mb_open_default" value=""> 
						<input type="checkbox" name="mb_open" value="1" checked="" id="reg_mb_open"> 다른분들이 나의 정보를 볼 수 있도록 합니다. 
					...
					<li class="is_captcha_use">자동등록방지
						<fieldset id="captcha" class="captcha recaptcha">
							...
							<script	src="https://demo.sir.kr/gnuboard5/plugin/recaptcha/recaptcha.js"></script>
							<div class="g-recaptcha" data-sitekey="6Lc1ujkUAAAAAOfWnj3UEheB87jjS_WF4sI_Q9YL">
