...
<div id="container">
	<h2 id="container_title">
		<span title="회원가입약관">회원가입약관</span>
	</h2>

	<!-- 회원가입약관 동의 시작 { -->

	<form name="fregister" id="fregister" action="/main/register_form" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
		...
		<section id="fregister_term">
			...
			<textarea readonly="">
				제 1 장 : 총칙 
				 ...
				 제1조(목적)
				 이 약관은 SIR(이하 "회사"라 한다)이 홈페이지에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
